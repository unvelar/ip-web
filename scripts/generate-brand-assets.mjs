...
function createSocialPreviewSvg(logoSvg) {
  ...
  <text x="496" y="345" fill="#44403c" font-family="Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, sans-serif" font-size="29" font-weight="600">Automated Brand Protection</text>
